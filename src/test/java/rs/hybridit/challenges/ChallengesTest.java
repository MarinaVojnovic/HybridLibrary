...
public class ChallengesTest {
	...
	public void checkIfStringIsAPalindrome_palindromeIsProvidedAsInput_valueIsConfirmedToBeAPalindrome() {
		isTrue(challenges.checkIfStringIsAPalindrome("ana"),
			"I expected a palindrome but result doesn't match my expectations!");
		isTrue(challenges.checkIfStringIsAPalindrome("aaa"),
			"I expected a palindrome but result doesn't match my expectations!");
		isTrue(challenges.checkIfStringIsAPalindrome("bbb"),
			"I expected a palindrome but result doesn't match my expectations!");
